...
from app.api.v1.endpoints import appraisals, projects, users, reports, auth, otp, clients, photos, templates, accounts, dashboard, appraisal_workflow, archive
...
api_router.include_router(archive.router, prefix="/archives", tags=["archives"])
